...
set scrolloff=5    	 " 5 строк скролле за раз
...
" User hotkeys
"=====================================================
" ConqueTerm запуск интерпретатора на F5
...
autocmd FileType javascript set omnifunc=javascriptcomplete#CompleteJS expandtab shiftwidth=2 tabstop=2 softtabstop=2
